...
class Facebook implements Tokenizable
{
    ...
    public function __construct()
    {
        ...
        $this->redirect_uri = route('socialaccounts.connect.callback', 'facebook');
    }
    ...
    {
        //return Socialite::with('facebook')->scopes(['pages_manage_posts', 'pages_read_engagement','publish_to_groups'])->redirect();
