...
@section('content')
    <div class="padding">
        ...
        <ul class="nav nav-sm nav-pills nav-active-primary clearfix">
            ...
            @if(count($Sections)>0)
                <li class="nav-item">
                    <a class="nav-link {{ ($active_tab==2) ? "active":"" }}" href data-toggle="tab"
            ...
            @if(count($Contacts)>0)
                <li class="nav-item">
                    <a class="nav-link {{ ($active_tab==3) ? "active":"" }}" href data-toggle="tab"
            ...
            @if(count($Events)>0)
                <li class="nav-item">
                    <a class="nav-link {{ ($active_tab==4) ? "active":"" }}" href data-toggle="tab"
            ...
            @if(count($Webmails)>0)
                <li class="nav-item">
                    <a class="nav-link {{ ($active_tab==5) ? "active":"" }}" href data-toggle="tab"
