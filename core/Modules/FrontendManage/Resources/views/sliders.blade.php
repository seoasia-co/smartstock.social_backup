                                                ...
                                                <div class="primary_input mb-25">
                                                    ...
                                                    <div class="primary_file_uploader">
                                                        ...
                                                        <div class="multi_btn">
                                                            ...
                                                            <button type="button" data-table="sliders"
                                                                    data-name="image"
                                                                    data-id="{{ isset($slider)?$slider->id:0}}"
                                            ...
                                            @if(!isModuleActive('Org'))
                                                ...
                                                <div class="col-xl-12" id="btn_image1">
                                                    ...
                                                    <div class="primary_file_uploader mb-25">
                                                        <input class="primary-input filePlaceholder courseLabel1"
                                                               type="text"
                                                        ...
                                                        <div class="multi_btn">
                                                            <button class="" type="button">
                                                                ...
                                                                <input type="file"
                                                                       class="d-none fileUpload courseLabel1"
                                                                       name="btn_image1"
                                                                       id="btn_image_1">
                                                            </button>
                                                            <button type="button" data-table="sliders"
