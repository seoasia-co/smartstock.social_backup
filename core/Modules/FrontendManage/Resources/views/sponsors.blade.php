                                                ...
                                                <div class="col-lg-12">
                                                    <div class="primary_input">
                                                        ...
                                                        <div class="primary_file_uploader">
                                                            <input class="primary-input filePlaceholder labelTitle"
                                                                   type="text"
                                                            ...
                                                            <div class="multi_btn">
                                                                <button class="" type="button">
                                                                    ...
                                                                    <input type="file"
                                                                           class="d-none fileUpload labelTitle"
                                                                           name="image"
                                                                           id="document_file1">
                                                                </button>
                                                                <button type="button" data-table="sponsors"
                                                                        data-name="image"
                                                                        data-id="{{ isset($sponsor) ? $sponsor->id : 0 }}"
